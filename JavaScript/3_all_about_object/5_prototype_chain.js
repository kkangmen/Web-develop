...
console.log(yuJin2.dance === wonYoung2.dance);
console.log(yuJin2.hasOwnProperty("dance"));

function IdolModel3(name, year) {
  this.name = name;
  this.year = year;
}
IdolModel3.prototype.dance = function () {
  `${this.name}이 춤을 춥니다.`;
};

const yuJin3 = new IdolModel3("안유진", 2002);
const wonYoung3 = new IdolModel3("장원영", 2002);
console.log(yuJin3.dance === wonYoung3.dance);
console.log(yuJin3.hasOwnProperty("dance"));
...
function IdolModel4(name, year) {
  ...
  this.sayHello = function () {
    return `이것은 instance 메서드입니다.`;
  };
}

IdolModel4.prototype.sayHello = function () {
  return `이것은 prototype메서드입니다.`;
};

const yuJin4 = new IdolModel4("안유진", 2002);
...
console.log(FemaleIdolModel.__proto__ === IdolModel.__proto__);
